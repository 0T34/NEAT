...
{  
  ...
  public void AddNodeMutation(InnovationMachine im, Random r)
  {
    ...
    do
    {
      Connection randomConnection = this.GetConnections().get(Math.round(r.nextFloat() * (this.GetConnections().size() - 1)));
  ...
  public void AdjustWeightMutation(Random r)
  {
    for(Connection c : this.GetConnections())
    {
  ...
  public void AddConnectionMutation(InnovationMachine im, Random r)
  {
    ...
    do
    {
      ...
      int from = Math.round(r.nextFloat() * (this.GetNodes().size() - 1)) + 1;
      int to = Math.round(r.nextFloat() * (this.GetNodes().size() - 1)) + 1;
      if (from == to)
      {
        continue;
      }
  ...
  public void AddBiasMutation(InnovationMachine im, Random r)
  {
    if (this.GetNodes().size() == 0)
    {
    ...
    do
    {
      int node = Math.round(r.nextFloat() * (this.GetNodes().size() - 1)) + 1; // find a random node
  ...
  public void AdjustBiasMutation(Random r)
  {
  ...
  public void EnableDisableConnectionMutation(Random r)
  {
    if (this.GetConnections().size() == 0)
    {
    ...
    connectionToToggle = this.GetConnections().get(Math.round(r.nextFloat() * (this.GetConnections().size() - 1)));
